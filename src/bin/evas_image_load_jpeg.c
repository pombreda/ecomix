...
static int ecomix_image_load_file_head_jpeg_internal(Image_Entry *ie, FILE *f);
static int ecomix_image_load_file_data_jpeg_internal(Image_Entry *ie, FILE *f);
#if 0 /* not used at the moment */
static int ecomix_image_load_file_data_jpeg_alpha_internal(Image_Entry *ie, FILE *f);
#endif
...
static int
ecomix_image_load_file_head_jpeg_internal(Image_Entry *ie, FILE *f)
{
...
static int
ecomix_image_load_file_data_jpeg_internal(Image_Entry *ie, FILE *f)
{
   int w, h;
   struct jpeg_decompress_struct cinfo;
   struct _JPEG_error_mgr jerr;
...
#if 0 /* not used at the moment */
static int
ecomix_image_load_file_data_jpeg_alpha_internal(Image_Entry *ie, FILE *f)
{
   int w, h;
   struct jpeg_decompress_struct cinfo;
   struct _JPEG_error_mgr jerr;
...
int
ecomix_image_load_file_head_jpeg(Image_Entry *ie, const char *file, const char *key)
{
   int val;
   FILE *f;
   ...
   f = fopen(file, "rb");
   if (!f) return 0;
   val = ecomix_image_load_file_head_jpeg_internal(ie, f);
   fclose(f);
   return val;
   key = 0;
}
...
int
ecomix_image_load_file_data_jpeg(Image_Entry *ie, const char *file, const char *key)
{
   int val;
   FILE *f;
   ...
   f = fopen(file, "rb");
   if (!f) return 0;
   val = ecomix_image_load_file_data_jpeg_internal(ie, f);
   fclose(f);
   return val;
   key = 0;
}
...
int
ecomix_image_load_fmem_head_jpeg(Image_Entry *ie, const char *file, const char *key, void *buf, size_t size)
{
   int val;
   FILE *f;
...
int
ecomix_image_load_fmem_data_jpeg(Image_Entry *ie, const char *file, const char *key, void *buf, size_t size)
{
   int val;
   FILE *f;
